...
public class Assignment1_DataTypes {
	...
	//3. Person's phone number: "123-456-7890"
		...
		System.out.println("Person's phone number: "+number);
	...
	//7. Person's marital status: true or false
		...
		String maritalStatus= "true or false";
		System.out.println("Person's marital status: "+maritalStatus);
		
	/*
	 * boolean maritalStatus = true; if(maritalStatus=true) {
	 * System.out.println("Person's marital status: "+maritalStatus); }else {
	 * System.out.println("Person's marital status: "+maritalStatus); }
	 */
	...
	//9. Person's favourite colour: "Blue
		...
		String favourateColour = "Blue";
		System.out.println("Person's favourite colour: "+favourateColour);
	...
	//15.Number of employees in a company: 500
		...
		short employess = 500;
		System.out.println("Number of employees in a company: "+employess);
